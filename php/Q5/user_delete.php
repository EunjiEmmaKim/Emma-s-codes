...
<?php
	...
	$delete_query = "DELETE FROM grocery_user WHERE user_id = '".$_GET['user_id']."'";
	mysql_query($delete_query);

	echo "<h5 class='alert alert-danger' role='alert' style='text-align : center; text-color: #31B404;'>The user has deleted successfully!</h5>";	
	// die();
...
?>
		...
		<div class="panel-footer">
				<a href="admin_page.php"><div class="btn">Go Back</div></a>	
		</div>		
		</div>
	</div>
