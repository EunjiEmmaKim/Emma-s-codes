...
<body>
	...
	<h2>Emma Bank</h2>
	<form method="post" action="withdraw_ok.php">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<table class="table table-striped table-bordered">
				<tr>	
					<td>$ <input type="text" name="user_withdraw" required/></td>					
					<td><input class="btn btn-primary" type="submit" name="withdraw" value="Withdraw" /></td>					
				</tr>
			</table>
		</div>
